                ...
                <tbody className="divide-y divide-gray-200 text-gray-900">
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group">
                      ...
                      <td className="bg-white px-4 py-5 text-sm">{customer.email}</td>
                      <td className="bg-white px-4 py-5 text-sm">{customer.total_invoices}</td>
                      <td className="bg-white px-4 py-5 text-sm">{customer.total_pending}</td>
                      <td className="bg-white px-4 py-5 text-sm">{customer.total_paid}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
